...
$container["JwtAuthentication"] = function ($container) {
    return new JwtAuthentication([
        "secure" => false,
        "path" => ["/rsvpEvent","/bookmarkEvent","/bookmarkContent","/appreciateContent","/myProfile","/addStudentSkills","/studentFollow","/notifications","/addContent","/addEvent","/addNew","/userImage", "/contentResponse", "/editDraftContent", "/movetoDraftContent", "/content", "/editDraftEvent", "/movetoDraftEvent", "/event"],
        "passthrough" => [],
